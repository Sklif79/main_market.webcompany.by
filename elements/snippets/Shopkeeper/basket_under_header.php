name:basket_under_header
description:Выводит выпадающую корзину со списком заказанных товаров
======
<?php
...
/*Выводит выпадающую корзину со списком заказанных товаров*/
	if(isset($_SESSION['purchases']) && !empty($_SESSION['purchases'])){
		...
		$basket_rowTpl = 'purchases_cartRowTpl_popup'; // название чанка шаблона вывода превью товаров в корзине
		$basket_outerTpl = 'basket_under_header_tpl'; //Название чанка шаблона контейнера корзины-попапа
