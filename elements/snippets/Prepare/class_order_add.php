name:class_order_add
description:<b>1.1</b> выводит класс, отключающий отображение элементов добавить в корзину. Prepare DocLister
======
<?php
<?php
/**
 * class_order_add
 *
 * выводит класс, отключающий отображение элементов добавить в корзину. Prepare DocLister
 *
 * @category 	snippet
 * @version 	1.1
