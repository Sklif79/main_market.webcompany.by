name:Страница Услуга с Кнопкой 2.0 (верстка)
description:
======
<!DOCTYPE html>
<html lang="ru">
				...
				<div class="primary-block uk-width-1-1 uk-width-medium-3-4">
					...
					<div class="service-image-wrap">
						<div class="service-image">
							<img src="/assets/templates/market/img/update/service-2.jpg" alt="">
						</div>
						<div class="service-image-info">
							...
							<p>
								Проектирование чертежа будущего торгового центра в г. Минске с использование AutoCAD и другого програмного обеспечения для  достижения цели 
							</p>

							<div class="service-image-info-lnk-wrap">
								<a href="#callback" data-uk-modal="" class="projects-card-info__lnk buy-btn">Заказать проект</a>
							</div>
						</div>
					</div>
