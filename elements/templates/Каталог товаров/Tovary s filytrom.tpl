name:Товары с фильтром
description:Product Group with filter
======
<!DOCTYPE html>
<html lang="ru">
	<head>
	...
	<body>
		...
		{{basket_under_header}} 
		[[breadcrumbs_select_load]]

		<div class="container second-page">

			<div class="uk-grid">
				{{left_bar_catalog_filter}}
				...
				<div class="primary-block uk-width-1-1 uk-width-medium-3-4">
					...
					<!--@-Вывод фильтра горизонтального-@-->
					[[filter_return? type=`horizontal`]]
					...
					<div id="product_cont">
						<div class="catalog-plitka uk-grid uk-grid-width-1-1 uk-grid-width-medium-1-2 uk-grid-width-large-1-3">
							...
							&pageAdjacents=`1`
							&noneWrapOuter=`0`
							&filters=`AND(content:template:in:38,64)`
							&prepare=`class_order_add`
							&tvSortType=`DECIMAL`
							&ownerTPL=`product_filter_owner_tpl`
							!]
						</div>
					</div>	
					<div id='product_site'  start='12' parent='[*id*]' ajax_url='[(site_url)][~1770~]'  type='table' sort='menuindex' sortdir='ASC' total='12' ids='[+eFilter_ids+]'></div>	
