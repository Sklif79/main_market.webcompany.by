				...
				<div class="primary-block uk-width-1-1 uk-width-medium-3-4">
					...
					<div id="product_cont">
						<div class="catalog-plitka uk-grid uk-grid-width-1-1 uk-grid-width-medium-1-2 uk-grid-width-large-1-3">
							[[DocLister? &id=`product` &parents=`[*id*]` &depth=`1` &tvPrefix=`` &tvList=`product_prev,novelty,sale,sale_persent,bestseller,articul,new_price,old_price,img_prew_prod` &tpl=`product_plitka_tpl` &orderBy=`menuindex ASC` &total=`12` &noneWrapOuter=`0` &filters=`AND(content:template:in:38,64)` &prepare=`class_order_add`]]
						</div>
						[[if? &is=`[[childcount? &idp=`[*id*]`]]:>:12` &then=`
						<div class="more-prod">
