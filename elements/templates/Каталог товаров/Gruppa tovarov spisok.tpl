name:Группа товаров список
description:Product Group spisok
======
<!DOCTYPE html>
<html lang="ru">
	<head>
				...
				<div class="primary-block uk-width-1-1 uk-width-medium-3-4">
					...
					<div id="product_cont">
						<div class="catalog-spisok">
							[[DocLister? &id=`product` &parents=`[*id*]` &depth=`0` &tvPrefix=`` &tvList=`product_prev,novelty,sale,sale_persent,bestseller,articul,new_price,old_price,img_prew_prod` &tpl=`production_spisok_tpl` &orderBy=`menuindex ASC` &total=`12` &noneWrapOuter=`0` &filters=`AND(content:template:in:38,64)`]]
						</div>
						<div class="more-prod">
