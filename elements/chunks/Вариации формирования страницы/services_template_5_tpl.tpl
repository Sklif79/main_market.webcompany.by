name:services_template_5_tpl
description:Шаблон вывода превью для пятого шаблона с выводом подразделов
======
	...
	<div class="completed-projects-slider-el">
		...
		<div class="completed-projects-slider__info">
			...
			<div class="completed-projects-slider__info-el">
				...
				[[if? &is=`[+isfolder+]:=:0` &then=`<a href="[+url+]">Подробнее</a>` &else=``]]
			</div>
