name:header-2_1
description:Верхняя часть сайта цветная (2.1)
======
<div class="header-top-var-2_1">
	...
	<div class="container">
		...
		<div class="wrap-menu">
			...
			<div class='search-wrap'>
				...
				<!--@-Корзина шопкипера
				[!basket_visible_and_type!]-@-->
				<!--@-[[-basket_visible_from_header? &id_param_val=`99` &tv_param_val_name=`site_header_config` &session_param_name=`site_footer_config` &params_array=`header_default,header-1_1,header-1_2,header-1_3,header-1_4`]]-@-->
			</div>
		</div>
	</div>
</div>