name:header-2_2
description:Темная верхняя часть (2.2)
======
<div class="header-top-var-2_2">

	<div class="top-bar">
		<div class="container top-bar-flex">
			{{top-menu}}
			[[ddGetMultipleField? &inputString_docField=`social_buttons` &inputString_docId=`1`
			&outerTpl=`social_buttons_header_outer_tpl` &rowTpl=`social_buttons_header_tpl`]]
		</div>
	</div>
		...
		<div class="flex-center-bar container">
			...
			<form class="center-bar-search" action="[~97~]">
				<input type="text" placeholder="Поиск..." required pattern='[A-Za-zА-Яа-яЁё-0-9]{3,50}' name='s'
					   class="center-bar-search__input"/>
				<button type="submit" class="center-bar-search__submit"><img
																			 src="assets/templates/market/img/update/magnifier-header-2.svg" alt=""/></button>
			</form>
			...
			<div class="phone flex-block">
				...
				<div>
					...
					<div class="header-phone-wrap">
						<div class="header__phone">[[GetPageParams? &iddoc=`1` &field=`header_phones_first_phone`]]
						</div>
						[[ddGetMultipleField? &inputString_docField=`header_phones_hidden_block` &inputString_docId=`1`
						&outerTpl=`@CODE:
						<div class="header-phones">[+result+]</div>
						` &rowTpl=`header_phones_hidden_block_tpl`]]
					</div>
				</div>
				<!--@-Корзина шопкипера-@-->
				<!--@-[!-basket_visible_and_type!]-@-->
			</div>
			[[ddGetMultipleField? &inputString_docField=`header_mobile_contacts` &inputString_docId=`1`
			&rowTpl=`header_mobile_contacts_tpl`]]
	...
	<div class="container">
		<!--@-{{main_menu_header? &class_dectop=`first-active`}}-@-->
		...
		<div class="wrap-menu">
			...
			<nav class="desktop-menu uk-hidden-small">
				[[ddGetMultipleField? &inputString_docField=`header_menu` &inputString_docId=`1` &rowTpl=`header_menu_level1_tpl` &outerTpl=`@CODE:<ul class="menu first-active flex" id="menu-flex">[+result+]</ul>`]]
			</nav>
