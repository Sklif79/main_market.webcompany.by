name:header-7_2
description:Цветной фон (7.2)
======
<div class="header-top-var-7_2">
		...
		<div class="flex-center-bar container">
			<div class="header-scroll-main-menu">
				<nav class="desktop-menu uk-hidden-small">
					[[DLMenu? &parents=`0` &maxDepth=`1` &filters=`AND(content:id:notin:1;content:template:notin:13,19,22,24)` &outerTpl=`@CODE:<ul [+classes+] id="header-trim-nav">[+wrap+]</ul>` &rowTpl=`scroll_dlmenu_rowTpl` &parentRowTpl=`mobile_dlmenu_parentRowTpl` &hereClass=`active` &activeClass=`active` &outerClass=`menu flex` &innerClass=`menu-sub`]]
				</nav>		
			</div>
