name:card_completed_projects_tpl
description:Шаблон вывода превью выполненных проектов в карточке товара
======
<div class="completed-projects-slider-el-wrap">
	<div class="completed-projects-slider-el">
		<div class="completed-projects-slider__img">
			<a href="[+url+]">
				<img src="[[phpthumb? &input=`[+services_img_prev_new+]` &options=`w=440,h=192,f=png,q=85,far=C,bg=ffffff`]]" alt="[+title+]">
			</a>
		</div>
