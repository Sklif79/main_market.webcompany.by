name:sale_last_tpl
description:шаблон вывода превью скидки последний элемент
======
<div class="sale-page uk-grid">
	<div class="uk-width-1-1 uk-width-large-1-3 uk-width-medium-2-5 uk-text-center">
		<a href="[+url+]">
			<img src="[[phpthumb? &input=`[+img_prev_sale+]` &options=`w=600,h=431,f=png,q=95,far=C,bg=ffffff`]]" alt="[+pagetitle+]"/>
		</a>
	</div>
