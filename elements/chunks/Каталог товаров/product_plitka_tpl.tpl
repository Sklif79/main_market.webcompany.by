name:product_plitka_tpl
description:Шаблон вывода элементов превью товаров в виде плитки
======
<div class="element">
	<div class="preview-product-element [+order+]"><!-- добавить класс order, чтобы появилась кнопка заказать -->
		<div class="outside-product">
			...
			<div class="more-block">
				<a href="[+url+]"><img src="assets/templates/market/img/eye-ico.png"> Подробнее
				</a>
			</div>
		</div>
	</div>
