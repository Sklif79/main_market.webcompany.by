...
<div class="card-reviews-el">
	<div class="card-reviews-el-header">
		<div class="card-reviews-el-header-info">
			...
			[[if? &is=`[+position_review+]:empty` &then=`` &else=`<div class="card-reviews-el-header__post">[+position_review+]</div>`]]
		</div>
		[[ddGetMultipleField? &inputString_docField='social_links_review' &inputString_docId='[+id+]' &rowTpl='social_links_review_tpl' &outerTpl='social_links_review_outer_tpl']]
	</div>
	<div class="card-reviews-el-inner">
		...
		<div class="card-reviews-el-inner-btns">
			<a href="[+url+]" class="card-reviews-el__more"><span>Читать подробнее...</span></a>
			[[if? &is=`[+original_review_doc+]:empty` &then=`` &else=`
			<a href="[+original_review_doc+]" class="fancyshow">
