name:custom_color_options_tpl
description:Шаблон вывода кастомного задания цветов
======
<div class="picker-window-wrap">
	<label class="custom-color radio">
	<span class="custom-color__vis">
		<?xml version="1.0" encoding="iso-8859-1"?>
		<!-- Generator: Adobe Illustrator 19.0.0, SVG Export Plug-In . SVG Version: 6.00 Build 0)  -->
<svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
y="0px" viewBox="0 0 512.387 512.387" style="enable-background:new 0 0 512.387 512.387;" xml:space="preserve">
...
c46.08-5.12,102.4-33.28,128-58.88C521.487,135.072,521.487,71.072,480.527,30.112z"/>
		...
		<input type="radio" name="[+tv_name+]" class="input-color" value="[+tv_value+]" [+is_checked+]/>
	</label>
</div>